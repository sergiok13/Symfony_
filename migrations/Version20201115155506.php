 ...
 */
final class Version20201115155506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE productos (id INT AUTO_INCREMENT NOT NULL, categoria_id INT DEFAULT NULL, nombre VARCHAR(100) NOT NULL, descripcion VARCHAR(100) DEFAULT NULL, precio VARCHAR(20) NOT NULL, imagen VARCHAR(255) DEFAULT NULL, tipo VARCHAR(255) DEFAULT NULL, INDEX IDX_767490E63397707A (categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
